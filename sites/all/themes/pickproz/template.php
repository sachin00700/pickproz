 ...
 * 1. Rename each function and instance of "pickproz" to match
 *    your subthemes name, e.g. if your theme name is "footheme" then the function
 *    name will be "footheme_preprocess_hook". Tip - you can search/replace
 *    on "pickproz".
 * 2. Uncomment the required function to use.
 * 3. Read carefully, especially within pickproz_preprocess_html(), there
 ...
 */
function pickproz_preprocess_html(&$vars) {
  // Load the media queries styles
  // Remember to rename these files to match the names used here - they are
  // in the CSS directory of your subtheme.
  $media_queries_css = array(
    'pickproz.responsive.style.css',
    'pickproz.responsive.gpanels.css'
  );
  load_subtheme_media_queries($media_queries_css, 'pickproz');
  ...
  */
  ...
  load_subtheme_ie_styles($ie_files, 'pickproz');
  // */
...
function pickproz_process_html(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function pickproz_preprocess_node(&$vars) {
}

function pickproz_process_node(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function pickproz_preprocess_comment(&$vars) {
}

function pickproz_process_comment(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function pickproz_preprocess_block(&$vars) {
}

function pickproz_process_block(&$vars) {
}
// */
